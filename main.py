...
#function to generate a random mac address on windows
...
#function to generate a random mac address on linux
...
#function to display the main menu of program
def display_menu():
    ...
    if (choice == "1"):
        ...
        if loaded_mac_addresses:
            for iface, new_mac_address in loaded_mac_addresses.items():
                if p == "win":
...
if __name__ == "__main__":
    print("\nDeveloper Name: Shayan Faysal")
    print("Subject: Ethical Hacking")
